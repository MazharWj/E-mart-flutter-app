...
import 'package:emart_app/consts/views/orders_screen/components/order_place_details.dart';
import 'package:emart_app/consts/views/orders_screen/components/order_status.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Divider(),
              10.heightBox,
              "Ordered Product".text.fontFamily(semibold).color(darkFontGrey).makeCentered(),
              10.heightBox,
              ListView(
                shrinkWrap: true,
