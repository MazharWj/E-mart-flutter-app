...
import 'package:emart_app/consts/views/cart_screen/payment_method.dart';
                  ...
                  child: ourButton(
                    ...
                    onPress: (){
                      if(controller.addressController.text.length > 2
                          // || controller.cityController.text.length > 2 || controller.stateController.text.length > 2 || controller.postalcodeController.text.length > 2 || controller.phoneController.text.length > 2
                      ){
